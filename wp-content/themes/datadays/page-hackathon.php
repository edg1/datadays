	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<div class="col-md-4 hackathon hackathon-citadel">
  			...
  			<h3>Citadel</h3>
  			<p>Create an app that works across the whole of Europe!</p>
  			<p>4 cities in Europe - Athens, Manchester, Ghent or Issy-les-Moulineaux - are publishing their data to make it possible to create an app that will work in your city!</p>
  		  <p>Join  Citadel the Move.  Make an app for your city.  And win in a place in the finals during the Data Days conference in Ghent, Belgium. The winner will take home a prize of 5000 EUR and a trip to one of the four pilot cities to test the app there!</p>
		  ...
		  <div class="col-md-4 hackathon hackathon-vkbo">
  			...
  			<h3>VKBO</h3>
  			<p>Are you a programmer or designer? A hacker through and through?</p>
